...
public:
    vector<vector<int>> getSkyline(vector<vector<int>>& buildings) {
        ...
        // A posição x atual, inicializada com a posição x do primeiro edifício.
        ...
        while (posicao < buildings.size() or not altura.empty()) {
            // Verifica se a próxima posição é o início de um novo edifício
            if (altura.empty()) {
           ...
           // Altura antes da próxima posição atual possível ser escolhida
            ...
            if (posicao < buildings.size()) {
                ...
                // Adiciona os edifícios na próxima posição x
                if (proximoL <= edificio) {
                 ...
                 // Fornece a próxima posição possível altura e define o ponto final
